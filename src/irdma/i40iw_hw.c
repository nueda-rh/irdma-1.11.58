...
static u32 i40iw_vf_regs[IRDMA_MAX_REGS] = {
	I40E_VFPE_CQPTAIL1,
	I40E_VFPE_CQPDB1,
...
static u32 i40iw_vf_stat_offsets[] = {
	I40E_GLPES_VFIP4RXDISCARD(0),
	I40E_GLPES_VFIP4RXTRUNC(0),
	I40E_GLPES_VFIP4TXNOROUTE(0),
	I40E_GLPES_VFIP6RXDISCARD(0),
	I40E_GLPES_VFIP6RXTRUNC(0),
	I40E_GLPES_VFIP6TXNOROUTE(0),
	I40E_GLPES_VFTCPRTXSEG(0),
	I40E_GLPES_VFTCPRXOPTERR(0),
	I40E_GLPES_VFTCPRXPROTOERR(0),
	I40E_GLPES_VFRXVLANERR(0),

	I40E_GLPES_VFIP4RXOCTSLO(0),
	I40E_GLPES_VFIP4RXPKTSLO(0),
	I40E_GLPES_VFIP4RXFRAGSLO(0),
	I40E_GLPES_VFIP4RXMCPKTSLO(0),
	I40E_GLPES_VFIP4TXOCTSLO(0),
	I40E_GLPES_VFIP4TXPKTSLO(0),
	I40E_GLPES_VFIP4TXFRAGSLO(0),
	I40E_GLPES_VFIP4TXMCPKTSLO(0),
	I40E_GLPES_VFIP6RXOCTSLO(0),
	I40E_GLPES_VFIP6RXPKTSLO(0),
	I40E_GLPES_VFIP6RXFRAGSLO(0),
	I40E_GLPES_VFIP6RXMCPKTSLO(0),
	I40E_GLPES_VFIP6TXOCTSLO(0),
	I40E_GLPES_VFIP6TXPKTSLO(0),
	I40E_GLPES_VFIP6TXFRAGSLO(0),
	I40E_GLPES_VFIP6TXMCPKTSLO(0),
	I40E_GLPES_VFTCPRXSEGSLO(0),
	I40E_GLPES_VFTCPTXSEGLO(0),
	I40E_GLPES_VFRDMARXRDSLO(0),
	I40E_GLPES_VFRDMARXSNDSLO(0),
	I40E_GLPES_VFRDMARXWRSLO(0),
	I40E_GLPES_VFRDMATXRDSLO(0),
	I40E_GLPES_VFRDMATXSNDSLO(0),
	I40E_GLPES_VFRDMATXWRSLO(0),
	I40E_GLPES_VFRDMAVBNDLO(0),
	I40E_GLPES_VFRDMAVINVLO(0),
	I40E_GLPES_VFIP4RXMCOCTSLO(0),
	I40E_GLPES_VFIP4TXMCOCTSLO(0),
	I40E_GLPES_VFIP6RXMCOCTSLO(0),
	I40E_GLPES_VFIP6TXMCOCTSLO(0),
	I40E_GLPES_VFUDPRXPKTSLO(0),
	I40E_GLPES_VFUDPTXPKTSLO(0),
};
...
static u8 i40iw_shifts[IRDMA_MAX_SHIFTS] = {
			     ...
			     bool enable)
{
	...
	reg_val = FIELD_PREP(I40E_PFINT_DYN_CTLN_ITR_INDX, IRDMA_IDX_NOITR) |
	...
	reg_val = FIELD_PREP(IRDMA_GLINT_CEQCTL_CAUSE_ENA, enable) |
		  ...
		  FIELD_PREP(IRDMA_GLINT_CEQCTL_ITR_INDX, IRDMA_IDX_NOITR);
...
static void i40iw_ena_irq(struct irdma_sc_dev *dev, u32 idx)
{
	...
	val = FIELD_PREP(IRDMA_GLINT_DYN_CTL_INTENA, 0x1) |
	      ...
	      FIELD_PREP(IRDMA_GLINT_DYN_CTL_ITR_INDX, IRDMA_IDX_NOITR);
