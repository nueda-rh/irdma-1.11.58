...
#define IRDMA_VCHNL_RESP_DEFAULT_SIZE	(sizeof(struct irdma_virtchnl_resp_buf))
...
#define IRDMA_CQPSQ_WS_FAILING_PORT_S 44
#define IRDMA_CQPSQ_WS_FAILING_PORT GENMASK_ULL(46, 44)
#define IRDMA_CQPSQ_WS_FAILOVER_PORT_S 40
#define IRDMA_CQPSQ_WS_FAILOVER_PORT GENMASK_ULL(42, 40)
