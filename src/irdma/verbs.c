...
static void irdma_alloc_push_page(struct irdma_qp *iwqp)
{
	...
	if (atomic64_read(&iwdev->rf->push_cnt) + 2 >
	    iwdev->rf->sc_dev.hw_attrs.max_hw_device_pages / 8)
		return;
	...
	if (!status && cqp_request->compl_info.op_ret_val <
		...
		qp->push_offset = 0;
		atomic64_add(2, &iwdev->rf->push_cnt);
	}
...
static u64 irdma_compute_push_wqe_offset(struct irdma_device *iwdev, u32 page_idx)
{
	...
	if (iwdev->rf->sc_dev.hw_attrs.uk_attrs.hw_rev == IRDMA_GEN_2) {
		...
		bar_off += iwdev->rf->ftype ? IRDMA_VF_BAR_RSVD : IRDMA_PF_BAR_RSVD;
	}
			 ...
			 struct ib_qp_init_attr *init_attr)
{
	...
	if (req.user_wqe_bufs) {
		struct irdma_ucontext *ucontext = kc_rdma_udata_to_drv_context(&iwqp->iwpd->ibpd,
									       udata);
			      ...
			      struct irdma_cq_poll_info *cq_poll_info)
{
	...
	if (cq_poll_info->error) {
		...
		if (cq_poll_info->ud_vlan_valid && (dev_to_rf(qp->dev))->vlan_parse_en) {
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 3, 0) || defined(RHEL_8_2) || defined(RHEL_8_3) || defined(RHEL_8_4) || defined(RHEL_8_5) || defined(RHEL_8_6) || defined(RHEL_8_7)
	.owner = THIS_MODULE,
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 2, 0) || defined(RHEL_8_2) || defined(RHEL_8_3) || defined(RHEL_8_4) || defined(RHEL_8_5) || defined(RHEL_8_6) || defined(RHEL_8_7)
	INIT_RDMA_OBJ_SIZE(ib_ah, irdma_ah, ibah),
#endif /* 5.2.0 */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 3, 0) || defined(RHEL_8_2) || defined(RHEL_8_3) || defined(RHEL_8_4) || defined(RHEL_8_5) || defined(RHEL_8_6) || defined(RHEL_8_7)
	INIT_RDMA_OBJ_SIZE(ib_cq, irdma_cq, ibcq),
#endif /* 5.3.0 */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 10, 0) || defined(RHEL_8_5) || defined(RHEL_8_6) || defined(RHEL_8_7)
...
#if defined(RHEL_7_7) || defined(RHEL_7_8) || defined(RHEL_7_9) || defined(RHEL_8_2) || defined(RHEL_8_3) || defined(RHEL_8_4) || defined(RHEL_8_5) || defined(RHEL_8_6) || defined(RHEL_8_7)
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 11, 0) || defined(RHEL_8_5) || defined(RHEL_8_6) || defined(RHEL_8_7)
